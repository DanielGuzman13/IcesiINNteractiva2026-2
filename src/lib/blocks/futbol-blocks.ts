...
export function defineFutbolBlocks() {
  ...
  Blocks['futbol_fin'] = {
    init: function () {
      this.appendDummyInput().appendField('FIN');
  ...
  Blocks['futbol_si'] = {
    init: function () {
      this.appendValueInput('CONDITION')
        .setCheck('Boolean')
        .appendField('SI');
      this.appendStatementInput('THEN').appendField('entonces');
      this.appendStatementInput('ELSE').appendField('SINO');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(270);
  ...
  Blocks['futbol_fin_si'] = {
    init: function () {
      this.appendDummyInput().appendField('FIN SI');
      this.setPreviousStatement(true, null);
      this.setColour(270);
  ...
  Blocks['futbol_repetir_4'] = {
    init: function () {
      this.appendStatementInput('DO').appendField('REPETIR 4 VECES');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(270);
  ...
  Blocks['futbol_defensa_cerca'] = {
    init: function () {
      this.appendDummyInput().appendField('hay defensa cerca');
  ...
  Blocks['futbol_distancia_arco'] = {
    init: function () {
      this.appendDummyInput().appendField('distancia al arco < 20');
      this.setOutput(true, 'Boolean');
      this.setColour(120);
  ...
  Blocks['futbol_pasar'] = {
    init: function () {
      this.appendDummyInput().appendField('pasar balón');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(230);
  ...
  Blocks['futbol_disparar'] = {
    init: function () {
      this.appendDummyInput().appendField('disparar');
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(230);
